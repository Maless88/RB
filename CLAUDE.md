...
apps/
  ...
  mcp-service       MCP server (stdio + HTTP, port 3005) — 50 tools for AI agents (default `full` profile; selectable via `MCP_TOOL_PROFILE`: workflow=21, atlas=16, personal=13, full=50 — see docs/mcp-client-setup.md#tool-profiles)
